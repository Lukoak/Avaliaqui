...
<head>
    ...
    <title>Login_USR - Avaliaqui</title>
...
<body class="space-background text-gray-200 flex items-center justify-center min-h-screen font-sans relative select-none">
    ...
    <div class="w-full max-w-sm p-8 bg-[#0a0a0c] bg-panel border border-[#333] border-line rounded-none shadow-[8px_8px_0px_rgba(0,0,0,0.8)] body.light-mode:shadow-[4px_4px_0px_rgba(0,0,0,0.1)] z-10">
        ...
        <div class="text-center mb-8 border-b border-[#333] border-line pb-4">
            ...
            <p class="text-[10px] font-mono text-gray-500 mt-2 uppercase tracking-widest">> Autenticar Usuário</p>
        </div>
        ...
        <form action="login" method="POST" class="space-y-5">
            <div>
                ...
                <input type="text" id="identifier" name="identifier" required placeholder="sys@domain.com"
            ...
            <div>
                <div class="flex justify-between items-center mb-1">
                    <label for="password" class="text-[10px] font-bold uppercase tracking-widest text-gray-400">Chave de Acesso (Senha)</label>
                    <a href="esqueci-senha.jsp" class="text-[10px] text-[#a855f7] hover:text-white font-mono uppercase tracking-widest transition-colors">Esqueci a Chave</a>
                </div>
        ...
        <div class="text-center mt-6 pt-4 border-t border-[#333] border-line flex justify-between items-center">
            <span class="text-[10px] font-mono text-green-700">SYS_READY</span>
            <a href="cadastro.jsp" class="text-[11px] font-mono text-gray-400 hover:text-white transition-colors uppercase">
                Criar Registro >
            </a>
        </div>
    </div>
